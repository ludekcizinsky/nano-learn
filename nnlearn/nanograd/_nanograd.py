...
class Var:
    ...
    Notes
    -----
    The author of this class is: Rasmus Berg Palm
    Github repo: https://github.com/rasmusbergpalm/nanograd/blob/main/nanograd.py
    """
    ...
    def log2(self) -> 'Var':
        return Var(np.log2(self.v), [(self, 1 / self.v * np.log(2))]) 
